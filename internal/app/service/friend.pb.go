...
func (x *AddFriendRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *DelFriendRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *DelFriendRequest) GetFriendId() string {
	if x != nil {
		return x.FriendId
	}
	return ""
...
var file_api_friend_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3f, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x22, 0x3f,
	0x0a, 0x10, 0x44, 0x65, 0x6c, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65,
